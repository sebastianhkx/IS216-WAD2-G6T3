...
class DAO{
    ...
    public function get_event_by_date_time($date, $past_time, $time, $user_id){
      ...
      public function get_task_by_date_time($date, $past_time, $time, $user_id, $repeatable){
        ...
        public function get_task_by_time($past_time, $time, $user_id, $repeatable){
            // STEP 1
            $connMgr = new ConnectionManager();
            $conn = $connMgr->getConnection();
            ...
            $sql = "SELECT * from task_list WHERE user_id = :user_id AND start_time between :past_time and :time AND repeatable = :repeatable";
